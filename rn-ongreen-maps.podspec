...
Pod::UI.puts "\e[32m[rn-ongreen-maps] Thank you for using rn-ongreen-maps ❤️!\e[0m"

Pod::Spec.new do |s|
  s.name = "rn-ongreen-maps"
  ...
  s.subspec 'Maps' do |ss|
    ...
    ss.compiler_flags = folly_compiler_flags
    ss.dependency 'rn-ongreen-maps/Generated'
    install_modules_dependencies(ss)
     # Add script phase to detect Google Maps
    ss.script_phases = [
       {
         :name => 'rn-ongreen-maps patches',
         :script => %(
           set -x
  ...
  s.subspec 'Google' do |ss|
    ...
    ss.dependency 'rn-ongreen-maps/Generated'
    ss.dependency 'rn-ongreen-maps/Maps'
    install_modules_dependencies(ss)
  end
